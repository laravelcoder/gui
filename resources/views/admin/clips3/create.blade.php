...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.clips.store'], 'files' => true, 'enctype' => 'multipart/form-data']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('title', trans('global.clips.fields.title').'', ['id' => 'title', 'class' => 'control-label']) !!}
