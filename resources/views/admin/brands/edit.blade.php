...
@section('content')
    ...
    {!! Form::model($brand, ['method' => 'PUT', 'route' => ['admin.brands.update', $brand->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($brand->image)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$brand->image) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$brand->image) }}"></a>
                    @endif
